...
class Applications(commands.Cog):
    ...
    # @isBotsOrWorkChannel
    # @commands.command(aliases = ["3v3app"])
    # async def _3v3app(self, ctx, *, args = None):
    #     await self.sendMessage(ctx, args, "3v3", 886972024885481493, 886973611221598238, 896444200432861237, "Application")
    ...
    # @isBotsOrWorkChannel
    # @commands.command(aliases = ["3v3change"])
    # async def _3v3change(self, ctx, *, args = None):
    #     await self.sendMessage(ctx, args, "change", 886972024885481493, 886973611221598238, 896479412617359361, "Change")  
